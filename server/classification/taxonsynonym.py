...
class RestTaxonSynonymType(RestClassification):
...
@RestTaxonIdSynonym.def_auth_request(
    ...
    perms={
        ...
        'classification.add_taxonsynonym': _("You are not allowed to add a synonym to a taxon"),
    }
)
...
@RestTaxonIdSynonymId.def_auth_request(
    ...
    perms={
        'classification.change_taxon': _("You are not allowed to modify a taxon"),
        'classification.change_taxonsynonym': _("You are not allowed to modify a synonym to a taxon"),
    }
)
...
@RestTaxonIdSynonymId.def_auth_request(
    ...
    perms={
        'classification.change_taxon': _("You are not allowed to modify a taxon"),
        'classification.delete_taxonsynonym': _("You are not allowed to delete a synonym from a taxon"),
    }
)
