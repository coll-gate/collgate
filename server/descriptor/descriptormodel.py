...
# from .models import DescriptorModel, DescriptorModelType, Descriptor, DescriptorModelTypeCondition, \
...
#             'label': dmt.get_label(),
#             'descriptor_type_group': dmt.descriptor_type.group_name,
...
#
#     dm = get_object_or_404(DescriptorModel, id=int(des_id))
#     dt = get_object_or_404(Descriptor, code=dt_code)
#
