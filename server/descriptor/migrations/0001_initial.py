    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', django.contrib.postgres.fields.jsonb.JSONField(default={})),
                ('description', models.TextField(blank=True, default='')),
                ('layout_content', django.contrib.postgres.fields.jsonb.JSONField(default={'type': 'undefined'})),
        ...
        migrations.AlterIndexTogether(
            name='descriptorvalue',
            index_together=set([('descriptor', 'language', 'ordinal'), ('descriptor', 'language'), ('code', 'language'), ('descriptor', 'language', 'value0'), ('descriptor', 'language', 'value1')]),
        ),
    ]
