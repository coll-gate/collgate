...
from accession.models import Accession, AccessionSynonym, Action, ActionData, ActionDataType
...
def get_action_id_step_idx_accession_list_count(request, act_id, step_idx):
    ...
    # @todo temporary panel for working ? oh yes better than to add another table !
