/**
 * @file conformitytest.js
 * @brief Display and manage a conformity test format of type of batch-action
...
Format.BatchActionTypeFormatDetailsView = Marionette.View.extend({
    ...
    template: require('../templates/actions/conformitytest.html'),
