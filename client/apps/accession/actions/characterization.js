/**
 * @file characterization.js
 * @brief Display and manage a characterization format of type of batch-action
...
Format.BatchActionTypeFormatDetailsView = Marionette.View.extend({
    ...
    template: require('../templates/actions/characterization.html'),
