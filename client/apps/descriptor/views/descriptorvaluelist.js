...
let View = AdvancedTable.extend({
    ...
    defaultColumns: [
        ...
        {name: 'value0', width: 'auto', sort_by: null}
    ],

    columnsOptions: {
        'id': {label: _t('Code'), width: 'auto', minWidth: true, /*event: 'changelabel'*/},
        'value0': {label: _t('Value0'), width: 'auto', minWidth: true, /*event: 'changelabel'*/}
    },
